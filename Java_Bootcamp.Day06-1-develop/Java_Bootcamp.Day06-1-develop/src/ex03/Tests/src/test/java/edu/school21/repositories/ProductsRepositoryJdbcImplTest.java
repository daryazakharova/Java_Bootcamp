...
public class ProductsRepositoryJdbcImplTest {
    ...
    private final Product EXPECTED_UPDATED_PRODUCT = new Product(1L, "Updated Product A", 15.99);

    @BeforeEach
    public void init() {
        // Create an in-memory database and initialize the repository
    ...
    public void testUpdate() {
        Product productToUpdate = new Product(1L, "Updated Product A", 15.99);
    ...
    public void testSave() {
        Product newProduct = new Product(6L, "Product F", 60.99);
