...
(1, 1, 'Hello from user1!', DEFAULT),
(2, 1, 'Hi user1! This is user2.', DEFAULT),
(3, 2, 'Welcome to chatroom 2!', DEFAULT),
(4, 3, 'User  4 has joined chatroom 3.', DEFAULT),
(5, 4, 'User  5 says hi!', DEFAULT);